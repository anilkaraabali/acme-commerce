...
interface ProductReviewsFormModalProps {
  isOpen: boolean;
  onOpenChange: () => void;
  productId: string;
}
...
const ProductReviewsFormModal: FC<ProductReviewsFormModalProps> = ({
  isOpen,
  onOpenChange,
  productId,
}) => {
  ...
  const handleFormSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      console.error('Reviews form submit error:', error);
    } finally {
      setIsLoading(false);
    }
  };
...
export type { ProductReviewsFormModalProps };
export { ProductReviewsFormModal };
